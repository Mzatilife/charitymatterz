...
if (isset($_POST['submit'])) {
    ...
    if (in_array($file_extension, $valid_ext)) {
        ...
        $result = $blog->addBlog($cat, $title, $author, $new_name, $content, $date);
        if ($result) {
            $msg = "Blog Uploaded";
        } else {
            $msg2 = "Error, couldn't upload the blog";
        }
    } else {
                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3 mb-3">
                                            ...
                                            <input type="date" name="date" class="form-control" id="date-input1" aria-describedby="button-addon2" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control required" name="content" id="validationTextarea1" placeholder="content goes here..............." required="" rows="6"></textarea>
                                            <div class="valid-feedback"> Looks good! </div>

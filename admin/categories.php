...
if (isset($_POST['add'])) {
    ...
    $result = $blog->addCategory($category);
...
if (isset($_POST['edit'])) {
    ...
    // passing login information
    $result = $blog->editCategory($id, $category);
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <strong class="mb-1">Categories</strong><span class="dot dot-lg bg-success ml-1"></span>
                                        <p class="small text-muted mb-1">This shows all blog categories. For new category hit the new category button.</p>
                                    </div>
                                    <div class="col-4 col-md-auto offset-4 offset-md-0 my-2">
                                        <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo">new category</button>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td id="cat_name<?php echo $rw['category_id'] ?>" style="text-transform:capitalize;"><?php echo $rw['category_name']; ?></td>
                                                        <td>
                                                        ...
                                                        <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <button class="dropdown-item edit" value="<?php echo $rw['category_id'] ?>">Edit</button>
                                                                <a class="dropdown-item text-danger" href="categories.php?del_id=<?php echo $rw['category_id'] ?>">Remove</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
